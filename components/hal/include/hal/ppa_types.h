...
typedef enum {
    ...
    PPA_SRM_COLOR_MODE_YUV422_UYVY = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_UYVY422),     /*!< PPA SRM color mode: YUV422 UYVY */
    PPA_SRM_COLOR_MODE_YUV422_VYUY = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_VYUY422),     /*!< PPA SRM color mode: YUV422 VYUY, only available on input */
    PPA_SRM_COLOR_MODE_YUV422_YUYV = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_YUYV422),     /*!< PPA SRM color mode: YUV422 YUYV, only available on input */
    PPA_SRM_COLOR_MODE_YUV422_YVYU = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_YVYU422),     /*!< PPA SRM color mode: YUV422 YVYU, only available on input */
...
typedef enum {
    ...
    PPA_BLEND_COLOR_MODE_YUV422_UYVY = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_UYVY422),  /*!< PPA blend color mode: YUV422 UYVY, only available on blend background input or on output */
    PPA_BLEND_COLOR_MODE_YUV422_VYUY = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_VYUY422),  /*!< PPA blend color mode: YUV422 VYUY, only available on blend background input */
    PPA_BLEND_COLOR_MODE_YUV422_YUYV = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_YUYV422),  /*!< PPA blend color mode: YUV422 YUYV, only available on blend background input */
    PPA_BLEND_COLOR_MODE_YUV422_YVYU = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_YVYU422),  /*!< PPA blend color mode: YUV422 YVYU, only available on blend background input */
...
typedef enum {
    ...
    PPA_FILL_COLOR_MODE_YUV422_UYVY = COLOR_TYPE_ID(COLOR_SPACE_YUV, COLOR_PIXEL_UYVY422),  /*!< PPA fill color mode: YUV422 UYVY */
